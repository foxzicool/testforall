...
export default {
  ...
  argTypes: {
    items: {
      control: 'object',
      description:
        'Array of menu items with subitems, each item might include a "to" and "external" property for links.',
    },
    location: {
      control: 'select',
  ...
  items: [
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          external: true,
          subItems: [
            { title: 'Sub-suboption 1-2-1', to: 'https://nuxt.com', external: false },
            { title: 'Sub-suboption 1-2-2', to: 'https://nuxt.com', external: true },
          ],
        },
      ],
    },
